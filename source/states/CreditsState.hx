...
class CreditsState extends MusicBeatState
{
	...
	function pushModCreditsToList(folder:String)
	{
		...
		if (#if TRANSLATIONS_ALLOWED (PsychFileSystem.exists(translatedCredits) && (creditsFile = translatedCredits) == translatedCredits) || #end PsychFileSystem.exists(creditsFile))
		{
